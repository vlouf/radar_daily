...
def get_key_metadata():
    cfkeys = dict()
    cfkeys["corrected_differential_reflectivity"] = {
        "standard_name": "log_differential_reflectivity_hv",
        "short_name": "ZDR",
        "units": "dB",
    }

    cfkeys["reflectivity"] = {"standard_name": "equivalent_reflectivity_factor", "short_name": "DBZ", "units": "dBZ"}

    cfkeys["region_dealias_velocity"] = {
        "standard_name": "radial_velocity_of_scatterers_away_from_instrument",
        "short_name": "VEL",
        "units": "m/s",
    }

    cfkeys["giangrande_differential_phase"] = {
        "standard_name": "differential_phase_hv",
        "short_name": "PHIDP",
        "units": "degrees",
    }

    cfkeys["giangrande_specific_differential_phase"] = {
        "standard_name": "specific_differential_phase_hv",
        "short_name": "KDP",
        "units": "degrees/km",
    }

    cfkeys["cross_correlation_ratio"] = {
        "standard_name": "cross_correlation_ratio_hv",
        "short_name": "RHOHV",
        "units": "",
    }

    cfkeys["radar_echo_classification"] = {
        "standard_name": "radar_echo_classification",
        "short_name": "REC",
        "units": "legend",
    }

    cfkeys["radar_estimated_rain_rate"] = {
        "standard_name": "radar_estimated_rain_rate",
        "short_name": "RRR",
        "units": "mm/hr",
    }

    cfkeys["cloud_top_height"] = {"standard_name": "convective_cloud_top_height", "short_name": "CTH", "units": "m"}

    cfkeys["0dB_echo_top_height"] = {"standard_name": "0dB_echo_top_height", "short_name": "0DB_ETH", "units": "m"}

    cfkeys["10dB_echo_top_height"] = {"standard_name": "10dB_echo_top_height", "short_name": "10DB_ETH", "units": "m"}

    cfkeys["17dB_echo_top_height"] = {"standard_name": "17dB_echo_top_height", "short_name": "17DB_ETH", "units": "m"}

    cfkeys["40dB_echo_top_height"] = {"standard_name": "40dB_echo_top_height", "short_name": "40DB_ETH", "units": "m"}

    cfkeys["steiner_echo_classification"] = {
        "standard_name": "steiner_echo_classification",
        "long_name": "Convetive stratiform echo classification",
        "units": "",
    }

    cfkeys["thurai_echo_classification"] = {
        "standard_name": "thurai_echo_classification",
        "long_name": "Convetive stratiform echo classification",
        "units": "",
    }
...
def write_ncfile(outfilename, time, xdim, ydim, latitude, longitude, moment, mykey_name, gnrl_meta, file_exist):
    ...
    dtime = netCDF4.num2date(
        time["data"], time["units"], only_use_cftime_datetimes=False, only_use_python_datetimes=True
    )
    ...
    global_metadata["summary"] = (
        f"{moment_name.replace('_', ' ')} retrievals produced"
    ...
    global_metadata["acknowledgement"] = (
    ...
    global_metadata["project"] = (
        "The vertical structure of convective mass-flux derived from modern "
    ...
    with netCDF4.Dataset(outfilename, "w", format="NETCDF4") as ncid:
        ...
        # Create variables.
        mymoment = ncid.createVariable(
            moment_name, moment["data"].dtype, ("time", "latitude", "longitude"), zlib=True, fill_value=-9999
        )
        ...
        ncquality.setncattr(
            "comment",
            "In case of a slice, at a given timestep, full of FillValue,"
